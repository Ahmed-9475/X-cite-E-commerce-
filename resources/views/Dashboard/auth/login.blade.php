            ...
            <div class="authentication-inner">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{old('email')}}" class="form-control"id="email"name="email" @error('email') is-invalid @enderror placeholder="Enter your email or username"autofocus/>
