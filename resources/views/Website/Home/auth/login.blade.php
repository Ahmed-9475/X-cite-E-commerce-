                    ...
                    <form class="card login-form" method="post">
                        <div class="card-body">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input class="form-control" value="{{old('name')}}" name="email" type="email" id="reg-email" required>
                            </div>
                            <div class="form-group input-group">
                            ...
                            <p class="outer-link">Don't have an account? <a href="{{route('register.user')}}">Register here </a>
                            </p>
                            @endif
                        </form>
                        </div>
